...
//			return targetFile.Exists && targetFile.Length == iTargetSize;
	...
	public KinectInterop.SensorData OpenDefaultSensor (KinectInterop.FrameSource dwFlags, float sensorAngle, bool bUseMultiSource)
	{
		...
		FacetrackingManager[] faceManagers = GameObject.FindObjectsByType<FacetrackingManager>(FindObjectsSortMode.None);//new
		...
		SpeechManager[] speechManagers = GameObject.FindObjectsByType<SpeechManager>(FindObjectsSortMode.None);//new
